...
function newItem(element) {
  ...
  if (element === 'blockquote') {
    newElement.addClass('blockquote');
    newElement
      .append($('<p></p>').addClass('mb-0').text('Write Quote'), $('<footer></footer>').addClass('blockquote-footer text-right').append($('<cite></cite>').text('author')));
      }
